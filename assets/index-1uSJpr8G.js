(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();class ge extends HTMLElement{shadow;_initialized=!1;constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this._initialized||(this.render(),this.setupEventListeners(),this._initialized=!0),this.onConnected()}disconnectedCallback(){this.onDisconnected()}attributeChangedCallback(e,t,o){t!==o&&this._initialized&&this.onAttributeChanged(e,t,o)}getBaseStyles(){return`
        ...
        `}renderZoneArcs(e,t,o,s){const a=parseInt(this.getAttribute("ftp")||"200",10),i=parseInt(this.getAttribute("max")||"500",10);return a<=0?"":fe.map((r,c)=>{const d=r.min*a/i,p=Math.min(r.max*a/i,1),l=(p-d)*t,m=t*(1-p);return`
                <circle 
                    ...
                    data-zone="${c+1}"
                />
            `}).join("")}getZone(e){for(const t of fe)if(e>=t.min&&e<t.max)return t;return e>=fe[fe.length-1].max?fe[fe.length-1]:null}onAttributeChanged(){this.render()}onDisconnected(){this.animationFrame&&cancelAnimationFrame(this.animationFrame)}animateToValue(e,t=300){const o=this.currentDisplayValue,s=performance.now(),a=i=>{const r=i-s,c=Math.min(r/t,1),d=1-Math.pow(1-c,3),p=Math.round(o+(e-o)*d);this.currentDisplayValue=p,this.setAttribute("value",String(p)),c<1&&(this.animationFrame=requestAnimationFrame(a))};this.animationFrame&&cancelAnimationFrame(this.animationFrame),this.animationFrame=requestAnimationFrame(a)}setValue(e,t=!1){t?this.animateToValue(e):(this.currentDisplayValue=e,this.setAttribute("value",String(e)))}setFTP(e){this.setAttribute("ftp",String(e))}}customElements.define("bpt-power-gauge",_n);const $t={1:{bg:"rgba(74, 144, 226, 0.15)",fill:"#3b82f6",text:"#2563eb"},2:{bg:"rgba(34, 197, 94, 0.15)",fill:"#22c55e",text:"#16a34a"},3:{bg:"rgba(234, 179, 8, 0.15)",fill:"#eab308",text:"#ca8a04"},4:{bg:"rgba(249, 115, 22, 0.15)",fill:"#f97316",text:"#ea580c"},5:{bg:"rgba(239, 68, 68, 0.15)",fill:"#ef4444",text:"#dc2626"},6:{bg:"rgba(168, 85, 247, 0.15)",fill:"#a855f7",text:"#9333ea"},7:{bg:"rgba(236, 72, 153, 0.15)",fill:"#ec4899",text:"#db2777"}};class Nn extends ge{static get observedAttributes(){return["zone","zone-name","percent","type","compact"]}getStyles(){return`
            :host {
                display: flex;
                flex-direction: column;
                gap: 4px;
    ...
    `,t}function Mo(n,e=[]){const t=document.createElement("div");t.className="workout-summary";const o=(a,i)=>a!==null?`${a}${i}`:"--";let s="";if(e.length>0&&(s=`
    ...
    `,n.powerZoneDistribution&&n.powerZoneDistribution.totalTimeMs>0){const a=Ot(n.powerZoneDistribution,"⚡ Power Zone Distribution");t.appendChild(a)}if(n.hrZoneDistribution&&n.hrZoneDistribution.totalTimeMs>0){const a=Ot(n.hrZoneDistribution,"❤️ Heart Rate Zone Distribution");t.appendChild(a)}return t}function Do(n,e,t=[]){return new Promise(o=>{let s=null;const a=Mo(n,t);s=Ke({title:"Workout Complete",content:a,icon:"🏁",closeOnOverlay:!1,buttons:[{text:"🗑️ Discard",variant:"danger",onClick:()=>{s?.(),e.onDiscard(),o("discard")}},{text:"▶️ Keep Recording",variant:"secondary",onClick:()=>{s?.(),e.onKeepRecording(),o("keep")}},{text:"💾 Save & Finish",variant:"primary",onClick:()=>{s?.(),e.onExport(),o("export")}}],onClose:()=>{e.onKeepRecording(),o("keep")}})})}let z=1,$e=1,Ce=!1,he="",Me="",De="",de="list",j=new Date,Pe="cloud";function J(n){if(!n.summary)return{};if(typeof n.summary=="string")try{return JSON.parse(n.summary)}catch{return{}}return n.summary}function Po(){const n=document.getElementById("historyPrevPage"),e=document.getElementById("historyNextPage"),t=document.getElementById("historyRefresh"),o=document.getElementById("workoutTypeFilter"),s=document.getElementById("workoutDateStart"),a=document.getElementById("workoutDateEnd"),i=document.getElementById("viewListBtn"),r=document.getElementById("viewCalendarBtn"),c=document.getElementById("viewAnalyticsBtn"),d=document.getElementById("workoutListView"),p=document.getElementById("workoutCalendarView"),l=document.getElementById("workoutAnalyticsView"),m=document.getElementById("calendarPrevMonth"),u=document.getElementById("calendarNextMonth"),h=document.getElementById("sourceCloudBtn"),g=document.getElementById("sourceLocalBtn");h&&g&&(h.addEventListener("click",()=>Vt("cloud")),g.addEventListener("click",()=>Vt("local"))),_o();const y=v=>{de=v,i&&(i.classList.toggle("active",v==="list"),i.setAttribute("aria-pressed",(v==="list").toString()),i.style.background=v==="list"?"var(--color-bg-active)":"transparent"),r&&(r.classList.toggle("active",v==="calendar"),r.setAttribute("aria-pressed",(v==="calendar").toString()),r.style.background=v==="calendar"?"var(--color-bg-active)":"transparent"),c&&(c.classList.toggle("active",v==="analytics"),c.setAttribute("aria-pressed",(v==="analytics").toString()),c.style.background=v==="analytics"?"var(--color-bg-active)":"transparent"),d&&(d.style.display=v==="list"?"block":"none"),p&&(p.style.display=v==="calendar"?"block":"none"),l&&(l.style.display=v==="analytics"?"block":"none")};i?.addEventListener("click",()=>{y("list"),K()}),r?.addEventListener("click",()=>{y("calendar"),Ae()}),c?.addEventListener("click",()=>{y("analytics"),pt()});const b=()=>{o&&(he=o.value),s&&(Me=s.value),a&&(De=a.value),z=1,de==="list"?K():de==="calendar"?Ae():de==="analytics"&&pt()};o?.addEventListener("change",b),s?.addEventListener("change",b),a?.addEventListener("change",b),m?.addEventListener("click",()=>{j.setMonth(j.getMonth()-1),Ae()}),u?.addEventListener("click",()=>{j.setMonth(j.getMonth()+1),Ae()}),n?.addEventListener("click",async()=>{z>1&&(z--,await K())}),e?.addEventListener("click",async()=>{z<$e&&(z++,await K())}),t?.addEventListener("click",async()=>{await K()})}async function _o(){const n=document.getElementById("workoutHistoryButton"),e=mt();try{Ce=await un()}catch{Ce=!1}!Ce&&e&&(Pe="local",hn()),n&&(n.disabled=!(Ce||e),n.title=Ce||e?"View workout history":"History not available")}function No(n){const e=pn(n.startTime,n.lastUpdated,n.measurements);return{id:n.id,title:"Local Workout",sport:"cycling",startTime:new Date(n.startTime).toISOString(),endTime:new Date(n.lastUpdated).toISOString(),duration:Math.round((n.lastUpdated-n.startTime)/1e3),status:"COMPLETED",summary:JSON.stringify(e),createdAt:new Date(n.startTime).toISOString(),updatedAt:new Date(n.lastUpdated).toISOString(),_synced:n.synced}}async function K(){const n=document.getElementById("workoutList"),e=document.getElementById("historyPageInfo"),t=document.getElementById("historyPrevPage"),o=document.getElementById("historyNextPage");if(n){n.innerHTML='<div class="workout-loading">Loading workouts...</div>';try{let s=[];if(Pe==="local"){const a=await dn();a.sort((d,p)=>p.startTime-d.startTime);const i=a.length;$e=Math.ceil(i/10)||1;const r=(z-1)*10;s=a.slice(r,r+10).map(No),e&&(e.textContent=`Page ${z} of ${$e} (${i} local)`)}else{const a={page:z,limit:10};he&&(a.sport=he),Me&&(a.startDate=new Date(Me)),De&&(a.endDate=new Date(De));const i=await Ge(a);s=i.workouts;const{pagination:r}=i;$e=r.totalPages,e&&(e.textContent=`Page ${r.page} of ${r.totalPages} (${r.total} total)`)}if(t&&(t.disabled=z<=1),o&&(o.disabled=z>=$e),s.length===0){n.innerHTML=`
        <div class="workout-empty">
          <p>No workouts found</p>
          <p class="workout-empty-hint">Start a workout to see it here!</p>
        </div>
      `;return}n.innerHTML=s.map(a=>Oo(a)).join(""),n.querySelectorAll(".workout-card").forEach(a=>{const i=a.dataset.workoutId;i&&(a.querySelector(".workout-view-btn")?.addEventListener("click",r=>{r.stopPropagation(),Je(i)}),a.querySelector(".workout-delete-btn")?.addEventListener("click",r=>{r.stopPropagation(),Ho(i)}),a.querySelector(".workout-sync-btn")?.addEventListener("click",r=>{r.stopPropagation(),Ro(i)}))})}catch(s){console.error("Failed to load workouts:",s);const a=s instanceof Error?s.message:"Unknown error";n.innerHTML=`
      <div class="workout-error">
        <p>Failed to load workouts</p>
        <p class="workout-error-detail">${a}</p>
      </div>
    `}}}function Vt(n){Pe!==n&&(Pe=n,hn(),z=1,K())}function hn(){const n=document.getElementById("sourceCloudBtn"),e=document.getElementById("sourceLocalBtn");n&&e&&(Pe==="cloud"?(n.classList.add("active"),n.setAttribute("aria-pressed","true"),n.style.background="var(--color-bg-active)",e.classList.remove("active"),e.setAttribute("aria-pressed","false"),e.style.background="transparent"):(e.classList.add("active"),e.setAttribute("aria-pressed","true"),e.style.background="var(--color-bg-active)",n.classList.remove("active"),n.setAttribute("aria-pressed","false"),n.style.background="transparent"))}async function Ro(n){const t=(await dn()).find(o=>o.id===n);if(t)try{S("Syncing workout...","polite");const o=await fo({streamName:`sync-${n}`,title:`Synced: ${ae(new Date(t.startTime))}`,sport:"cycling"});if(o.success&&o.workout)if((await vo(o.workout.id,!1)).success)await Gn(n),S("Workout synced successfully","assertive"),await K();else throw new Error("Failed to complete workout on server")}catch(o){console.error("Sync failed",o),S("Sync failed","assertive")}}function Oo(n){const e=n.status.toLowerCase(),t=J(n),s=n._synced===!1?'<button class="workout-sync-btn" title="Upload to server">☁️ Sync</button>':n._synced===!0?'<span title="Synced" style="margin-right:8px;">✅</span>':"";return`
  ...
  `}function Fo(n){const t=`workout-${new Date(n.startTime).toISOString().replace(/[:.]/g,"-").slice(0,19)}`,o={id:n.id,title:n.title,sport:n.sport,startTime:n.startTime,endTime:n.endTime,duration:n.duration,summary:n.summary,telemetry:n.telemetry},s=new Blob([JSON.stringify(o,null,2)],{type:"application/json"}),a=URL.createObjectURL(s),i=document.createElement("a");i.href=a,i.download=`${t}.json`,i.click(),URL.revokeObjectURL(a)}async function Ho(n){if(confirm("Are you sure you want to delete this workout? This cannot be undone."))try{await wo(n),await K()}catch(e){console.error("Failed to delete workout:",e);const t=e instanceof Error?e.message:"Unknown error";alert(`Failed to delete workout: ${t}`)}}async function Ae(){const n=document.getElementById("workoutCalendarGrid"),e=document.getElementById("calendarMonthLabel");if(!n||!e)return;const t=["January","February","March","April","May","June","July","August","September","October","November","December"];e.textContent=`${t[j.getMonth()]} ${j.getFullYear()}`,n.innerHTML='<div style="grid-column: 1 / -1; text-align: center; padding: 20px;">Loading calendar...</div>';const o=j.getFullYear(),s=j.getMonth(),a=new Date(o,s,1),i=new Date(o,s+1,0,23,59,59,999);try{const r={startDate:a,endDate:i,limit:1e3};he&&(r.sport=he);const d=(await Ge(r)).workouts;Uo(d),zo(d)}catch(r){console.error("Failed to load calendar:",r),n.innerHTML='<div style="grid-column: 1 / -1; text-align: center; color: var(--color-error);">Failed to load calendar data</div>'}}function Uo(n){const e=document.getElementById("workoutCalendarGrid");if(!e)return;e.innerHTML="",["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].forEach(r=>{const c=document.createElement("div");c.textContent=r,c.style.textAlign="center",c.style.fontWeight="bold",c.style.padding="4px",c.style.fontSize="0.9em",c.style.color="var(--color-text-secondary)",e.appendChild(c)});const o=j.getFullYear(),s=j.getMonth(),a=new Date(o,s,1).getDay(),i=new Date(o,s+1,0).getDate();for(let r=0;r<a;r++){const c=document.createElement("div");e.appendChild(c)}for(let r=1;r<=i;r++){const c=document.createElement("div");c.style.border="1px solid var(--color-border)",c.style.borderRadius="4px",c.style.minHeight="60px",c.style.padding="4px",c.style.background="var(--card-bg)",c.style.position="relative";const d=document.createElement("div");d.textContent=r.toString(),d.style.fontSize="0.8em",d.style.marginBottom="4px",c.appendChild(d),n.filter(m=>{const u=new Date(m.startTime);return u.getDate()===r&&u.getMonth()===s&&u.getFullYear()===o}).forEach(m=>{const u=document.createElement("div");u.title=`${m.title||"Workout"} (${pe(m.duration||0)})`,u.style.fontSize="0.7em",u.style.whiteSpace="nowrap",u.style.overflow="hidden",u.style.textOverflow="ellipsis",u.style.cursor="pointer",u.style.padding="2px",u.style.marginTop="2px",u.style.borderRadius="2px",u.style.background="var(--color-bg-active)",u.style.color="var(--color-text-primary)";const h=m.sport==="running"?"🏃":"🚴";u.textContent=`${h} ${pe(m.duration||0)}`,u.addEventListener("click",g=>{g.stopPropagation(),Je(m.id)}),c.appendChild(u)});const l=new Date;r===l.getDate()&&s===l.getMonth()&&o===l.getFullYear()&&(c.style.borderColor="var(--color-accent)",d.style.fontWeight="bold",d.style.color="var(--color-accent)"),e.appendChild(c)}}function zo(n){const e=document.getElementById("monthlyStats");if(!e)return;const t=n.length,o=n.reduce((i,r)=>i+(r.duration||0),0),s=n.reduce((i,r)=>{const c=J(r);return i+(c.totalDistance||0)},0),a=n.reduce((i,r)=>{const c=J(r);return i+(c.totalEnergy||0)},0);e.innerHTML=`
    ...
    `}async function pt(){if(!document.getElementById("workoutAnalyticsView"))return;const e=document.getElementById("prList");e&&(e.innerHTML='<div style="padding: 12px; text-align: center;">Loading records...</div>');try{const t={limit:1e3};he&&(t.sport=he),Me&&(t.startDate=new Date(Me)),De&&(t.endDate=new Date(De));const s=(await Ge(t)).workouts;let a=[];if(s.length>0&&s[0].userId)try{a=await xo(s[0].userId)}catch(i){console.warn("Failed to load FTP history",i)}Wo(s,a)}catch(t){console.error("Failed to load analytics:",t),e&&(e.innerHTML='<div style="color: var(--color-error); text-align: center;">Failed to load data</div>')}}function Wo(n,e=[]){qo(n),jo(n),Zo(n),Go(n),Ko(e),Jo(n)}function qo(n){const e=document.getElementById("prList");if(!e)return;let t={val:0,date:"",id:""},o={val:0,date:"",id:""},s={val:0,date:"",id:""},a={val:0,date:"",id:""};n.forEach(r=>{const c=J(r),d=ae(r.startTime);c.maxPower&&c.maxPower>t.val&&(t={val:c.maxPower,date:d,id:r.id}),c.maxHeartrate&&c.maxHeartrate>o.val&&(o={val:c.maxHeartrate,date:d,id:r.id}),r.duration&&r.duration>s.val&&(s={val:r.duration,date:d,id:r.id}),c.totalDistance&&c.totalDistance>a.val&&(a={val:c.totalDistance,date:d,id:r.id})});const i=(r,c,d,p)=>`
    ...
    `;e.innerHTML=`
        ...
        ${s.val>0?i("Longest Duration",pe(s.val),s.date,s.id):""}
        ${a.val>0?i("Longest Distance",`${(a.val/1e3).toFixed(1)} km`,a.date,a.id):""}
    `,e.querySelectorAll(".pr-row").forEach(r=>{r.addEventListener("click",()=>{const c=r.dataset.id;c&&Je(c)})})}function jo(n){const e=document.getElementById("trainingLoadChart");if(!e)return;const t={};for(let s=3;s>=0;s--){const a=new Date;a.setDate(a.getDate()-s*7);const i=Ft(a);t[`${a.getFullYear()}-W${i}`]=0}n.forEach(s=>{const a=J(s);if(a.trainingLoad){const i=new Date(s.startTime),r=`${i.getFullYear()}-W${Ft(i)}`;t[r]!==void 0&&(t[r]+=a.trainingLoad)}});const o=Math.max(...Object.values(t),100);e.innerHTML=Object.entries(t).map(([s,a])=>{const i=a/o*100;return`
        ...
        <svg width="100%" height="100%" viewBox="0 0 ${s} ${a}" preserveAspectRatio="none">
            ...
            ${c.map(l=>`
                ...
                <text x="${l.x}" y="${a-10}" text-anchor="middle" font-size="10" fill="var(--color-text-secondary)">${Yo(l.duration)}</text>
            `).join("")}
        </svg>
    `;e.innerHTML=p}function Yo(n){return n<60?`${n}s`:n<3600?`${n/60}m`:`${n/3600}h`}function Go(n){const e=document.getElementById("fitnessTrendChart");if(!e)return;const t=[...n].sort((E,C)=>new Date(E.startTime).getTime()-new Date(C.startTime).getTime());if(t.length<2){e.innerHTML='<div style="display:flex; justify-content:center; align-items:center; height:100%; color: var(--color-text-secondary);">Not enough data for trend analysis</div>';return}const o=new Map;t.forEach(E=>{const C=J(E);if(C.trainingLoad){const L=new Date(E.startTime).toISOString().split("T")[0],P=o.get(L)||0;o.set(L,P+C.trainingLoad)}});const s=[],a=new Date(t[0].startTime),i=new Date,r=Math.exp(-1/42),c=Math.exp(-1/7);let d=0,p=0;for(let E=new Date(a);E<=i;E.setDate(E.getDate()+1)){const C=E.toISOString().split("T")[0],L=o.get(C)||0;d=d*r+L*(1-r),p=p*c+L*(1-c),s.push({date:new Date(E),ctl:d,atl:p,tsb:d-p})}const l=e.clientWidth||600,m=250,u={top:20,right:30,bottom:30,left:40},h=l-u.left-u.right,g=m-u.top-u.bottom,y=Math.max(...s.map(E=>Math.max(E.ctl,E.atl)))*1.1,b=i.getTime()-a.getTime();if(b===0)return;const v=E=>u.left+(E.getTime()-a.getTime())/b*h,w=E=>u.top+g-E/y*g,f="M "+s.map(E=>`${v(E.date)},${w(E.ctl)}`).join(" L "),T="M "+s.map(E=>`${v(E.date)},${w(E.atl)}`).join(" L "),I=`
    ...
    `;e.innerHTML=I}function Ko(n){const e=document.getElementById("ftpHistoryChart");if(!e)return;if(n.length===0){e.innerHTML='<div style="display:flex; justify-content:center; align-items:center; height:100%; color: var(--color-text-secondary);">No FTP history available</div>';return}const t=[...n].sort((v,w)=>new Date(v.createdAt).getTime()-new Date(w.createdAt).getTime()),o=e.clientWidth||600,s=200,a={top:20,right:30,bottom:30,left:40},i=o-a.left-a.right,r=s-a.top-a.bottom,c=Math.max(...t.map(v=>v.ftp))*1.1,d=Math.max(0,Math.min(...t.map(v=>v.ftp))*.9),p=c-d||100,l=new Date(t[0].createdAt),u=new Date().getTime()-l.getTime(),h=v=>{const w=new Date(v);return a.left+(w.getTime()-l.getTime())/u*i},g=v=>a.top+r-(v-d)/p*r;let y="";if(t.length>0){y=`M ${h(t[0].createdAt)},${g(t[0].ftp)}`;for(let v=1;v<t.length;v++){const w=h(t[v].createdAt),f=g(t[v-1].ftp),T=g(t[v].ftp);y+=` L ${w},${f} L ${w},${T}`}y+=` L ${o-a.right},${g(t[t.length-1].ftp)}`}const b=`
    ...
    text-align: center;
    font-weight: 500;
  `,o.textContent=n,document.body.appendChild(o),setTimeout(()=>{window.matchMedia("(prefers-reduced-motion: reduce)").matches?o.remove():(o.style.opacity="0",o.style.transition="opacity 0.3s ease",setTimeout(()=>o.remove(),300))},t)}function V(n){const e=document.getElementById(n);if(!e)throw new Error(`Critical DOM element missing: #${n}. Ensure index.html is correct.`);return e}const gn="bpt-user-profile",Ut={ftp:null,maxHr:null,weight:null,onboardingComplete:!1,lastUpdated:null};function _e(){try{const n=localStorage.getItem(gn);if(n)return{...Ut,...JSON.parse(n)}}catch(n){console.warn("Failed to load user profile:",n)}return{...Ut}}function ht(n){try{n.lastUpdated=Date.now(),localStorage.setItem(gn,JSON.stringify(n))}catch(e){console.warn("Failed to save user profile:",e)}}const ue=[{id:"welcome",title:"Welcome to Bike Power Tracker!",icon:"🚴",content:`
    ...
    `,s.querySelector(".export-workout-btn")?.addEventListener("click",c=>{c.stopPropagation(),fs(n)}),t&&s.querySelector(".delete-workout-btn")?.addEventListener("click",d=>{d.stopPropagation(),confirm(`Delete workout "${n.name}"?`)&&(ms(n.id),xe(),S(`Deleted workout: ${n.name}`,"assertive"))}),s.addEventListener("click",c=>{if(c.target.tagName==="BUTTON")return;Wt(n);const d=document.getElementById("workoutSelectionModal");d&&(d.style.display="none")}),s.addEventListener("keydown",c=>{if(c.key==="Enter"||c.key===" "){c.preventDefault(),Wt(n);const d=document.getElementById("workoutSelectionModal");d&&(d.style.display="none")}}),e.appendChild(s)}function Wt(n){if(R){if(!confirm("A workout is already active. Stop it and start this one?"))return;R.stop()}je.init(),R=new us(n),R.setCallback(vs);const e=document.getElementById("workoutPlayerOverlay");e&&(e.style.display="block"),S(`Starting workout: ${n.name}. Ready to start.`,"assertive")}function ys(){const n=document.getElementById("workoutPlayerOverlay"),e=document.getElementById("wpMinimize"),t=document.getElementById("wpClose"),o=document.getElementById("wpSkip");n&&(t?.addEventListener("click",()=>{R&&confirm("Stop current workout?")&&(R.stop(),R=null,n.style.display="none",S("Workout stopped","polite"))}),e?.addEventListener("click",()=>{const s=n.querySelector(".workout-player-body");if(s){const a=s.style.display==="none";s.style.display=a?"block":"none",e.textContent=a?"_":"□"}}),o?.addEventListener("click",()=>{R&&(R.nextStep(),S("Skipped to next step","polite"))}))}function vs(n){const e=document.getElementById("wpWorkoutName"),t=document.getElementById("wpStepDescription"),o=document.getElementById("wpStepTime"),s=document.getElementById("wpStepDuration"),a=document.getElementById("wpTargetPower"),i=document.getElementById("wpNextStep"),r=document.getElementById("wpProgress");if(e&&(e.textContent=n.workout.name),n.currentStep){t&&(t.textContent=n.currentStep.description||n.currentStep.type.toUpperCase());const c=n.currentStep.duration-n.stepElapsedTime;o&&(o.textContent=st(c)),s&&(s.textContent=st(n.currentStep.duration)),a&&(a.textContent=n.targetPower?n.targetPower.toString():"--")}if(i)if(n.nextStep){const c=ws(n.nextStep);i.textContent=`${n.nextStep.type} (${st(n.nextStep.duration)}${c})`}else i.textContent="Finish";if(r){const c=n.stepElapsedTime/n.currentStep.duration*100;r.style.width=`${Math.min(100,c)}%`,n.currentStep.type==="active"?r.style.backgroundColor="#ff9800":n.currentStep.type==="rest"||n.currentStep.type==="warmup"?r.style.backgroundColor="#2196F3":r.style.backgroundColor="#4CAF50"}if(n.isFinished){const c=document.getElementById("workoutPlayerOverlay");c&&(c.style.display="none"),R=null,alert("Workout Complete!"),S("Workout Complete!","assertive")}}function st(n){const e=Math.floor(n/60),t=n%60;return`${e.toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}function ws(n){return n.targetValue?` @ ~${n.targetValue}${n.targetType==="percent_ftp"?"%":"W"}`:""}function qt(){R&&R.start()}function jt(){R&&R.pause()}let me=[];function wn(){const n=document.getElementById("createWorkoutBtn"),e=document.getElementById("closeBuilderModal"),t=document.getElementById("wbCancel"),o=document.getElementById("wbSave"),s=document.getElementById("wbAddStepRef");n&&n.addEventListener("click",bs),e&&e.addEventListener("click",gt),t&&t.addEventListener("click",gt),o&&o.addEventListener("click",Ts),s&&s.addEventListener("click",xs);const a=document.getElementById("wbTargetType");a&&a.addEventListener("change",()=>{const i=document.getElementById("wbTargetValue");i&&(i.parentElement.style.display=a.value==="open"?"none":"block")})}function bs(){const n=document.getElementById("workoutBuilderModal"),e=document.getElementById("workoutSelectionModal");e&&(e.style.display="none"),n&&(n.style.display="flex",Es())}function gt(){const n=document.getElementById("workoutBuilderModal");n&&(n.style.display="none")}function Es(){me=[],document.getElementById("wbName").value="",document.getElementById("wbDesc").value="",St()}function xs(){const n=document.getElementById("wbStepType").value,e=document.getElementById("wbStepDuration").value,t=document.getElementById("wbTargetType").value,o=document.getElementById("wbTargetValue").value,s=parseInt(e,10);if(isNaN(s)||s<=0){alert("Invalid duration");return}let a;if(t!=="open"&&(a=parseInt(o,10),isNaN(a))){alert("Invalid target value");return}const i={type:n,duration:s,targetType:t,targetValue:a,description:`${bn(n)} (${En(s)})`};me.push(i),St(),S(`Added step: ${i.description}`,"polite")}function St(){const n=document.getElementById("wbStepsList");if(n){if(me.length===0){n.innerHTML=`<div class="wb-step-empty" style="text-align: center; color: var(--color-text-secondary); padding: 1rem; border: 1px dashed var(--color-border);">
                        No steps added yet.
            ...
            <div>
                <strong>${t+1}. ${bn(e.type)}</strong> - ${En(e.duration)}
        ...
        `,n.appendChild(o)}),n.querySelectorAll(".remove-step-btn").forEach(e=>{e.addEventListener("click",t=>{const o=parseInt(t.target.getAttribute("data-index")||"-1",10);o>=0&&(me.splice(o,1),St())})})}}function Ts(){const n=document.getElementById("wbName").value.trim(),e=document.getElementById("wbDesc").value.trim();if(!n){alert("Please enter a workout name");return}if(me.length===0){alert("Please add at least one step");return}const t={id:crypto.randomUUID(),name:n,description:e,steps:me,tags:["custom"]};yn(t),xe(),gt(),S(`Workout saved: ${n}`,"assertive")}function bn(n){return n.charAt(0).toUpperCase()+n.slice(1)}function En(n){const e=Math.floor(n/60),t=n%60;return e>0?`${e}m ${t}s`:`${t}s`}class Ss{id="workouts";isInitialized=!1;init(e){const t=document.getElementById("workoutSelectionTemplate");if(t){const o=t.content.cloneNode(!0);e.appendChild(o),setTimeout(()=>{ps(),wn(),this.isInitialized=!0},0)}else console.error("Workouts template not found!"),e.innerHTML="<p>Error loading workouts view</p>"}onEnter(){this.isInitialized?xe():setTimeout(()=>xe(),50)}onLeave(){}}const xn="bpt-settings",M={power:!0,cadence:!0,heartrate:!0,speed:!0,distance:!0,altitude:!0,treadmillSpeed:!1,power3s:!1,highContrast:!1,colorblindPatterns:!1,voiceEnabled:!1,voiceLaps:!0,voiceZones:!0,exportTcx:!0,exportCsv:!0,exportJson:!1,exportFit:!1,debugMode:!1};function te(){const n=localStorage.getItem(xn);return n?{...M,...JSON.parse(n)}:{...M}}function ks(n){localStorage.setItem(xn,JSON.stringify(n)),window.dispatchEvent(new CustomEvent("settings-changed"))}const Z={isEnabled(){return!!te().debugMode},async log(n,e){if(this.isEnabled())try{const t=this.bufferToHex(e.buffer);await Un(n,t)}catch(t){console.warn("Failed to log debug data",t)}},bufferToHex(n){return[...new Uint8Array(n)].map(e=>e.toString(16).padStart(2,"0")).join("").toUpperCase()},async exportLogs(){const n=await Bt(),e=new Blob([JSON.stringify(n,null,2)],{type:"application/json"}),t=URL.createObjectURL(e),o=document.createElement("a");o.href=t,o.download=`bpt-debug-logs-${Date.now()}.json`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(t)},async clearLogs(){await zn()},async getLogCount(){return(await Bt()).length}};function Cs(){const n=document.getElementById("saveSettings"),e=document.getElementById("settingFtp"),t=document.getElementById("settingMaxHr"),o=document.getElementById("settingWeight"),s=document.getElementById("settingSpeed"),a=document.getElementById("settingDistance"),i=document.getElementById("settingAltitude"),r=document.getElementById("settingPower"),c=document.getElementById("settingCadence"),d=document.getElementById("settingHeartrate"),p=document.getElementById("settingTreadmillSpeed"),l=document.getElementById("settingPower3s"),m=document.getElementById("settingHighContrast"),u=document.getElementById("settingColorblindPatterns"),h=document.getElementById("settingVoiceEnabled"),g=document.getElementById("settingVoiceLaps"),y=document.getElementById("settingVoiceZones"),b=document.getElementById("settingExportTcx"),v=document.getElementById("settingExportCsv"),w=document.getElementById("settingExportJson"),f=document.getElementById("settingExportFit"),T=document.getElementById("settingDebugMode"),I=document.getElementById("debugControls"),E=document.getElementById("downloadDebugLogs"),C=document.getElementById("clearDebugLogs"),L=x=>{const $=(Y,Mn)=>{document.querySelectorAll(`.metric-group-${Y}`).forEach(Dn=>{Dn.style.display=Mn?"flex":"none"})};$("speed",x.speed),$("distance",x.distance),$("altitude",x.altitude),$("power",x.power),$("cadence",x.cadence),$("heartrate",x.heartrate),$("treadmillSpeed",x.treadmillSpeed),document.querySelectorAll(".metric-group-power").forEach(Y=>{x.power3s?Y.setAttribute("data-show-avg","true"):Y.removeAttribute("data-show-avg")}),x.highContrast?document.documentElement.setAttribute("data-high-contrast","true"):document.documentElement.removeAttribute("data-high-contrast"),x.colorblindPatterns?document.documentElement.setAttribute("data-colorblind-patterns","true"):document.documentElement.removeAttribute("data-colorblind-patterns"),I&&(I.style.display=x.debugMode?"flex":"none")},P=()=>{const $={..._e(),ftp:e?.value?Number(e.value):null,maxHr:t?.value?Number(t.value):null,weight:o?.value?Number(o.value):null};ht($),window.dispatchEvent(new CustomEvent("user-profile-changed"));const Q={speed:s?.checked??M.speed,distance:a?.checked??M.distance,altitude:i?.checked??M.altitude,power:r?.checked??M.power,cadence:c?.checked??M.cadence,heartrate:d?.checked??M.heartrate,treadmillSpeed:p?.checked??M.treadmillSpeed,power3s:l?.checked??M.power3s,highContrast:m?.checked??M.highContrast,colorblindPatterns:u?.checked??M.colorblindPatterns,voiceEnabled:h?.checked??M.voiceEnabled,voiceLaps:g?.checked??M.voiceLaps,voiceZones:y?.checked??M.voiceZones,exportTcx:b?.checked??M.exportTcx,exportCsv:v?.checked??M.exportCsv,exportJson:w?.checked??M.exportJson,exportFit:f?.checked??M.exportFit,debugMode:T?.checked??M.debugMode};ks(Q),L(Q)},D=()=>{const x=te(),$=_e();e&&(e.value=$.ftp?.toString()??""),t&&(t.value=$.maxHr?.toString()??""),o&&(o.value=$.weight?.toString()??""),r&&(r.checked=x.power),c&&(c.checked=x.cadence),d&&(d.checked=x.heartrate),s&&(s.checked=x.speed),a&&(a.checked=x.distance),i&&(i.checked=x.altitude),p&&(p.checked=x.treadmillSpeed),l&&(l.checked=x.power3s),m&&(m.checked=x.highContrast),u&&(u.checked=x.colorblindPatterns),h&&(h.checked=x.voiceEnabled),g&&(g.checked=x.voiceLaps),y&&(y.checked=x.voiceZones),b&&(b.checked=x.exportTcx),v&&(v.checked=x.exportCsv),w&&(w.checked=x.exportJson),f&&(f.checked=x.exportFit),T&&(T.checked=x.debugMode),L(x)};n?.addEventListener("click",P),E?.addEventListener("click",()=>{Z.exportLogs()}),C?.addEventListener("click",async()=>{confirm("Are you sure you want to clear all debug logs?")&&(await Z.clearLogs(),alert("Logs cleared."))}),D()}class Ls{id="settings";init(e){const t=document.getElementById("settingsTemplate");if(t){const o=t.content.cloneNode(!0);e.appendChild(o),setTimeout(()=>{Cs()},0)}else console.error("Settings template not found!"),e.innerHTML="<p>Error loading settings view</p>"}onEnter(){console.log("Entered Settings View")}onLeave(){console.log("Left Settings View")}}var q=(n=>(n.Dashboard="dashboard",n.History="history",n.Workouts="workouts",n.Settings="settings",n))(q||{});class Is{container;router;constructor(e){this.router=e,this.container=document.createElement("nav"),this.container.id="bottom-nav",this.container.className="bottom-nav",this.render(),document.body.appendChild(this.container),window.addEventListener("route-changed",t=>{const o=t.detail;this.setActive(o.viewId)})}render(){this.container.innerHTML=`
        ...
        `,this.container.querySelectorAll(".nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.target;t===q.Dashboard?this.router.navigate("/"):t&&this.router.navigate("/"+t)})})}setActive(e){this.container.querySelectorAll(".nav-item").forEach(t=>{t.dataset.target===e?(t.classList.add("active"),t.setAttribute("aria-current","page")):(t.classList.remove("active"),t.removeAttribute("aria-current"))})}}function $s(){const n=new po(V("mainContent")),e=new ho,t=new Xo,o=new Ss,s=new Ls;n.registerView(e),n.registerView(t),n.registerView(o),n.registerView(s),n.addRoute("/",q.Dashboard),n.addRoute("/history",q.History),n.addRoute("/workouts",q.Workouts),n.addRoute("/settings",q.Settings),new Is(n);const a=document.getElementById("settingsButton");return a&&a.addEventListener("click",()=>{n.navigate("/settings");const i=document.querySelector("nav details");i&&(i.open=!1)}),n}const ft=n=>{const e=Math.floor(n/1e3),t=Math.floor(e/3600),o=Math.floor(e%3600/60),s=e%60;return`${t.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}`};function Zt(n){return n.startTime?n.running?"recording":"paused":"idle"}function Le(n,e){const{startButton:t,pauseButton:o,resumeButton:s,stopButton:a}=n;switch(t.style.display="none",o.style.display="none",s.style.display="none",a.style.display="none",e){case"idle":t.style.display="inline-flex";break;case"recording":o.style.display="inline-flex";break;case"paused":s.style.display="inline-flex",a.style.display="inline-flex";break}}const As=n=>{const e=document.getElementById("startButton"),t=document.getElementById("pauseButton"),o=document.getElementById("resumeButton"),s=document.getElementById("stopButton"),a=document.getElementById("time"),i=document.getElementById("metricsTable");if(!e||!t||!o||!s||!a||!i){console.warn("Workout control elements not found in DOM");return}const r={startButton:e,pauseButton:t,resumeButton:o,stopButton:s};setInterval(()=>{let d="00:00:00";const p=Zt(n);if(n.startTime&&n.running){const l=Date.now()-n.startTime;d=ft(l)}else if(n.startTime&&n.endTime){const l=n.endTime-n.startTime;d=ft(l)}a.textContent!==d&&(a.textContent=d),i.classList.remove("recording","paused"),p==="recording"?i.classList.add("recording"):p==="paused"&&i.classList.add("paused")},100),Le(r,Zt(n));const c=(d,p)=>{const l=m=>{m.stopPropagation(),p()};d.addEventListener("click",l)};c(e,()=>{n.startTime=Date.now(),n.endTime=null,n.running=!0,qt(),Le(r,"recording"),Oe("recording"),S("Workout started","assertive")}),c(t,()=>{n.running=!1,n.endTime=Date.now(),jt(),Le(r,"paused"),Oe("paused"),S("Workout paused. Press resume to continue or stop to save.","assertive")}),c(o,()=>{if(n.endTime&&n.startTime){const d=Date.now()-n.endTime;n.startTime+=d}n.endTime=null,n.running=!0,qt(),Le(r,"recording"),Oe("recording"),S("Workout resumed","assertive")}),c(s,()=>{n.running=!1,jt(),Le(r,"paused"),Oe("paused"),S("Workout stopped and saved. Press resume to continue or export your data.","assertive");const d=new CustomEvent("workoutComplete",{detail:{startTime:n.startTime,endTime:n.endTime,duration:n.endTime&&n.startTime?n.endTime-n.startTime:0}});document.dispatchEvent(d)})},ee=(n,e)=>{const t=[];let o=0;for(const s of e){for(;o<n.length&&n[o].timestamp<s;)o++;const a=o-1;let i;const r=o>=n.length;if(a<0)i=n[o];else if(r)i=n[a];else{const c=n[a]?.timestamp??0,d=n[o]?.timestamp??0;i=s-c<=d-s?n[a]:n[o]}i?.timestamp!==void 0&&Math.abs(i.timestamp-s)<1e3?t.push(i.value):t.push(null)}return t},kt=n=>{const e=n.gps.map(f=>({timestamp:f.timestamp,value:f.lat})),t=n.gps.map(f=>({timestamp:f.timestamp,value:f.lon})),o=[n.heartrate,n.cadence,n.power,n.speed,n.distance,n.altitude,e];if(!o.some(f=>f.length>0))return[];const a=o.map(f=>f.length>0?f[0].timestamp:1/0),i=Math.min(...a),r=Math.max(...o.map(f=>f.length>0?f[f.length-1].timestamp:-1/0)),c=1e3,d=[];let p=i;for(;p<=r;)d.push(p),p+=c;const l=ee(n.heartrate,d),m=ee(n.cadence,d),u=ee(n.power,d),h=ee(n.speed,d),g=ee(n.distance,d),y=ee(n.altitude,d),b=ee(e,d),v=ee(t,d),w=[];for(let f=0;f<d.length;f++)w.push({timestamp:d[f],heartrate:l[f],cadence:m[f],power:u[f],speed:h[f],distance:g[f],altitude:y[f],lat:b[f],lon:v[f]});return w},Bs=n=>{const e=kt(n);if(!e||e.length===0)return"";const t="timestamp,power,cadence,heartrate,speed,distance,altitude,lat,lon",o=e.map(s=>{const a=new Date(s.timestamp).toISOString(),i=s.power!==null?Math.round(s.power):"",r=s.cadence!==null?Math.round(s.cadence):"",c=s.heartrate!==null?Math.round(s.heartrate):"",d=s.speed!==null?s.speed.toFixed(1):"",p=s.distance!==null?Math.round(s.distance):"",l=s.altitude!==null?Math.round(s.altitude):"",m=s.lat!==null?s.lat.toFixed(6):"",u=s.lon!==null?s.lon.toFixed(6):"";return`${a},${i},${r},${c},${d},${p},${l},${m},${u}`});return[t,...o].join(`
`)},Ms=n=>n!==null?`<HeartRateBpm><Value>${Math.round(n)}</Value></HeartRateBpm>`:"",Ds=n=>n!==null?`<Cadence>${Math.round(n)}</Cadence>`:"",Ps=n=>n===null?"":`<Extensions>
              <TPX xmlns="http://www.garmin.com/xmlschemas/ActivityExtension/v2">
                <Watts>${Math.round(n)}</Watts>
              </TPX>
            </Extensions>`,_s=n=>{const e=new Date(n.timestamp).toISOString();let t="";n.lat!==null&&n.lon!==null&&(t=`
        <Position>
            <LatitudeDegrees>${n.lat}</LatitudeDegrees>
            <LongitudeDegrees>${n.lon}</LongitudeDegrees>
        </Position>`);let o="";n.altitude!==null&&(o=`<AltitudeMeters>${n.altitude}</AltitudeMeters>`);let s="";n.distance!==null&&(s=`<DistanceMeters>${n.distance}</DistanceMeters>`);const a=[];return n.heartrate!==null&&a.push(Ms(n.heartrate)),n.cadence!==null&&a.push(Ds(n.cadence)),n.power!==null&&a.push(Ps(n.power)),`
<Trackpoint>
    <Time>${e}</Time>
    ${t}
    ${o}
...
`)}
    ...
    `.trim()},Ns=n=>{const e=kt(n);if(!e||e.length===0)return"";const t=e[0].timestamp,o=e[e.length-1].timestamp,s=Math.round((o-t)/1e3),a=new Date(t).toISOString();return`<?xml version="1.0" encoding="UTF-8"?>
...
`)}
    ...
    </TrainingCenterDatabase>`},Rs=32,Yt=2067,Os=0,Vs=1,Fs=34,Hs=18,Us=19,zs=20,Ws=21,H=0,at=2,Ie=132,_=134,qs=0,js=1,Zs=2,Ys=3,Gs=4,Ks=253,Js=3,Xs=4,Qs=7,ea=253,ta=2,na=7,oa=8,sa=5,aa=6,ra=0,ia=1,ca=253,la=2,da=7,ua=8,ma=0,pa=1,ha=253,ga=0,fa=1,ya=253,va=0,wa=1,ba=2,Ea=3,xa=4,Ta=5,Sa=4,ka=255,Ca=2,La=6,Gt=0,Ia=8,$a=9,Aa=26,Ba=0,Ve=1,Ma=0,Da=Date.UTC(1989,11,31,0,0,0);function Kt(n,e,t){const o=[0,52225,55297,5120,61441,15360,10240,58369,40961,27648,30720,46081,20480,39937,34817,17408];let s=0;for(let a=e;a<t;a++){const i=n[a];let r=o[s&15];s=s>>4&4095,s=s^r^o[i&15],r=o[s&15],s=s>>4&4095,s=s^r^o[i>>4&15]}return s}function rt(n){return Math.round((n-Da)/1e3)}class Pa{buffer=[];definedMessages=new Map;writeHeader(){this.buffer.push(14),this.buffer.push(Rs),this.buffer.push(Yt&255),this.buffer.push(Yt>>8&255),this.buffer.push(0,0,0,0),this.buffer.push(46,70,73,84),this.buffer.push(0,0)}writeDefinition(e,t,o){this.buffer.push(64|e&15),this.buffer.push(0),this.buffer.push(0),this.buffer.push(t&255),this.buffer.push(t>>8&255),this.buffer.push(o.length);for(const s of o)this.buffer.push(s.fieldDefNum),this.buffer.push(s.size),this.buffer.push(s.baseType);this.definedMessages.set(e,!0)}writeData(e,t){this.buffer.push(e&15);for(const o of t);}writeUint8(e){this.buffer.push(e&255)}writeUint16(e){this.buffer.push(e&255),this.buffer.push(e>>8&255)}writeUint32(e){this.buffer.push(e&255),this.buffer.push(e>>8&255),this.buffer.push(e>>16&255),this.buffer.push(e>>24&255)}writeDataHeader(e){this.buffer.push(e&15)}finalize(){const e=new Uint8Array(this.buffer),t=this.buffer.length-14;e[4]=t&255,e[5]=t>>8&255,e[6]=t>>16&255,e[7]=t>>24&255;const o=Kt(e,0,12);e[12]=o&255,e[13]=o>>8&255;const s=Kt(e,0,e.length),a=new Uint8Array(e.length+2);return a.set(e),a[e.length]=s&255,a[e.length+1]=s>>8&255,a}getBuffer(){return this.buffer}}const _a=n=>{const e=kt(n);if(!e||e.length===0)return null;const t=new Pa;t.writeHeader();const o=e[0].timestamp,s=e[e.length-1].timestamp,a=rt(o),i=rt(s),r=(s-o)/1e3,c=Math.round(r*1e3),d=0,p=1,l=2,m=3,u=4,h=5,g=6;t.writeDefinition(d,Os,[{fieldDefNum:qs,size:1,baseType:H},{fieldDefNum:js,size:2,baseType:Ie},{fieldDefNum:Zs,size:2,baseType:Ie},{fieldDefNum:Ys,size:4,baseType:_},{fieldDefNum:Gs,size:4,baseType:_}]),t.writeDataHeader(d),t.writeUint8(Sa),t.writeUint16(ka),t.writeUint16(1),t.writeUint32(12345678),t.writeUint32(a),t.writeDefinition(p,Vs,[{fieldDefNum:0,size:2,baseType:Ie},{fieldDefNum:1,size:1,baseType:at}]),t.writeDataHeader(p),t.writeUint16(100),t.writeUint8(1),t.writeDefinition(l,Ws,[{fieldDefNum:ha,size:4,baseType:_},{fieldDefNum:ga,size:1,baseType:H},{fieldDefNum:fa,size:1,baseType:H}]),t.writeDataHeader(l),t.writeUint32(a),t.writeUint8(Gt),t.writeUint8(Ba),t.writeDefinition(m,zs,[{fieldDefNum:Ks,size:4,baseType:_},{fieldDefNum:Js,size:1,baseType:at},{fieldDefNum:Xs,size:1,baseType:at},{fieldDefNum:Qs,size:2,baseType:Ie}]);for(const y of e){const b=rt(y.timestamp);t.writeDataHeader(m),t.writeUint32(b),t.writeUint8(y.heartrate!==null?Math.min(255,Math.round(y.heartrate)):255),t.writeUint8(y.cadence!==null?Math.min(255,Math.round(y.cadence)):255),t.writeUint16(y.power!==null?Math.round(y.power):65535)}return t.writeDataHeader(l),t.writeUint32(i),t.writeUint8(Gt),t.writeUint8(Ve),t.writeDefinition(u,Us,[{fieldDefNum:ca,size:4,baseType:_},{fieldDefNum:la,size:4,baseType:_},{fieldDefNum:da,size:4,baseType:_},{fieldDefNum:ua,size:4,baseType:_},{fieldDefNum:ma,size:1,baseType:H},{fieldDefNum:pa,size:1,baseType:H}]),t.writeDataHeader(u),t.writeUint32(i),t.writeUint32(a),t.writeUint32(c),t.writeUint32(c),t.writeUint8($a),t.writeUint8(Ve),t.writeDefinition(h,Hs,[{fieldDefNum:ea,size:4,baseType:_},{fieldDefNum:ta,size:4,baseType:_},{fieldDefNum:na,size:4,baseType:_},{fieldDefNum:oa,size:4,baseType:_},{fieldDefNum:sa,size:1,baseType:H},{fieldDefNum:aa,size:1,baseType:H},{fieldDefNum:ra,size:1,baseType:H},{fieldDefNum:ia,size:1,baseType:H}]),t.writeDataHeader(h),t.writeUint32(i),t.writeUint32(a),t.writeUint32(c),t.writeUint32(c),t.writeUint8(Ca),t.writeUint8(La),t.writeUint8(Ia),t.writeUint8(Ve),t.writeDefinition(g,Fs,[{fieldDefNum:ya,size:4,baseType:_},{fieldDefNum:va,size:4,baseType:_},{fieldDefNum:wa,size:2,baseType:Ie},{fieldDefNum:ba,size:1,baseType:H},{fieldDefNum:Ea,size:1,baseType:H},{fieldDefNum:xa,size:1,baseType:H},{fieldDefNum:Ta,size:4,baseType:_}]),t.writeDataHeader(g),t.writeUint32(i),t.writeUint32(c),t.writeUint16(1),t.writeUint8(Ma),t.writeUint8(Aa),t.writeUint8(Ve),t.writeUint32(i),t.finalize()},Na=5e3;function Ra(n){const{message:e,onUndo:t,onExpire:o,timeout:s=Na,icon:a="🗑️"}=n;document.querySelector(".undo-notification")?.remove();const r=document.createElement("div");r.className="undo-notification",r.setAttribute("role","alert"),r.setAttribute("aria-live","assertive");const c=Math.ceil(s/1e3);let d=c;r.innerHTML=`
...
`);p=u.pop()||"";for(const h of u){if(!h.trim())continue;const g=h.match(/^data:\s*(.+)$/m);if(g)try{const y=JSON.parse(g[1]);y.type==="connected"&&t?t(y):y.type==="message"&&e(y)}catch(y){console.error("Error parsing SSE data:",y)}}}}catch(r){if(r.name==="AbortError")return;console.error("SSE connection error:",r),o&&o(r)}finally{a=!1}})(),i}function pr(n,e,t,o){const s=`${Ne}/api/streams/${n}/listen`;return kn(s,e,t,o)}function hr(n,e,t){const o=`${Ne}/api/streams/listenAll`;return kn(o,n,e,t)}async function gr(n,e){const t=JSON.stringify({power:e.power??null,cadence:e.cadence??null,heartrate:e.heartrate??null,speed:e.speed??null,distance:e.distance??null,altitude:e.altitude??null,incline:e.incline??null,timestamp:e.timestamp,elapsed:e.elapsed,dataType:"workout_metrics"});return mr(n,t,"bike-power-tracker")}class fr{modal=null;currentConnection=null;streamMetricsSection=null;allStreamsMetricsSection=null;allStreamsConnection=null;streamCards=new Map;streamRows=new Map;isCompactView=!1;constructor(){this.initModal(),this.initInlineViewer(),this.initAllStreamsViewer()}initInlineViewer(){if(this.streamMetricsSection=document.getElementById("streamMetrics"),!this.streamMetricsSection){console.warn("Stream metrics section not found in DOM");return}const e=document.getElementById("closeStreamView");e&&e.addEventListener("click",()=>this.disconnectFromStream())}initAllStreamsViewer(){if(this.allStreamsMetricsSection=document.getElementById("allStreamsMetrics"),!this.allStreamsMetricsSection){console.warn("All streams metrics section not found in DOM");return}const e=document.getElementById("closeAllStreamsView");e&&e.addEventListener("click",()=>this.disconnectFromAllStreams());const t=document.getElementById("toggleViewBtn");t&&t.addEventListener("click",()=>this.toggleAllStreamsView())}toggleAllStreamsView(){this.isCompactView=!this.isCompactView;const e=document.getElementById("allStreamsGrid"),t=document.getElementById("allStreamsList"),o=document.getElementById("toggleViewBtn");this.isCompactView?(e&&(e.style.display="none"),t&&(t.style.display="flex"),o&&(o.textContent="🔲",o.title="Toggle grid view",o.classList.add("active"))):(e&&(e.style.display="grid"),t&&(t.style.display="none"),o&&(o.textContent="📋",o.title="Toggle compact view",o.classList.remove("active")))}initModal(){const e=document.createElement("div");e.id="streamViewerModal",e.className="stream-modal",e.innerHTML=`
    ...
    `,document.head.appendChild(n)}async function Cr(n){kr();const e=Sr(n);return document.body.appendChild(e),new Promise(t=>{const o=e.querySelector("#recovery-restore-btn"),s=e.querySelector("#recovery-discard-btn"),a=()=>{e.close(),e.remove()};o.addEventListener("click",()=>{a(),t("restore")}),s.addEventListener("click",()=>{a(),t("discard")}),e.addEventListener("cancel",i=>{i.preventDefault()}),e.showModal()})}async function Lr(n,e){try{if(!await Yn())return!1;const t=await bt();return t?await Cr(t)==="restore"?(n.restore({heartrate:t.heartrate,power:t.power,cadence:t.cadence,speed:t.speed,distance:t.distance,altitude:t.altitude,laps:t.laps,gps:t.gps||[]},t.startTime),e.startTime=t.startTime,e.running=!1,console.log(`Restored workout with ${t.power.length} power readings`),!0):(await wt(),console.log("User discarded recovered workout"),!1):!1}catch(t){return console.error("Error during workout recovery:",t),!1}}let we=null;const Ir=()=>{window.addEventListener("beforeinstallprompt",n=>{n.preventDefault(),we=n,$r()}),window.addEventListener("appinstalled",()=>{console.log("PWA was installed successfully"),we=null,vt()})},$r=()=>{const n=document.getElementById("installPrompt");if(!n)return;n.style.display="block",document.getElementById("installButton")?.addEventListener("click",async()=>{if(!we)return;await we.prompt();const{outcome:o}=await we.userChoice;console.log(`User response to the install prompt: ${o}`),we=null,vt()}),document.getElementById("dismissInstall")?.addEventListener("click",()=>{vt()})},vt=()=>{const n=document.getElementById("installPrompt");n&&(n.style.display="none")};function Ar(){const n=document.getElementById("aboutButton"),e=document.getElementById("aboutModal"),t=document.getElementById("closeAboutModal");if(!n||!e)return;const o=()=>{e.style.display="flex";const a=document.querySelector("header details");a&&a.removeAttribute("open")},s=()=>{e.style.display="none"};n.addEventListener("click",o),t?.addEventListener("click",s),window.addEventListener("click",a=>{a.target===e&&s()})}const Br=()=>{let n=null;const e=async()=>{try{"wakeLock"in navigator&&(n=await navigator.wakeLock.request("screen"),console.log("Screen wake lock activated"),n.addEventListener("release",()=>{console.log("Screen wake lock released")}))}catch(t){console.error("Wake lock request failed:",t)}};document.visibilityState==="visible"&&e(),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&e()})};function Mr(n={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:o,onRegistered:s,onRegisteredSW:a,onRegisterError:i}=n;let r,c;const d=async(l=!0)=>{await c};async function p(){if("serviceWorker"in navigator){if(r=await xt(async()=>{const{Workbox:l}=await import("./workbox-window.prod.es5-BIl4cyR9.js");return{Workbox:l}},[]).then(({Workbox:l})=>new l("/sw.js",{scope:"/",type:"classic"})).catch(l=>{i?.(l)}),!r)return;r.addEventListener("activated",l=>{(l.isUpdate||l.isExternal)&&window.location.reload()}),r.addEventListener("installed",l=>{l.isUpdate||o?.()}),r.register({immediate:e}).then(l=>{a?a("/sw.js",l):s?.(l)}).catch(l=>{i?.(l)})}}return c=p(),d}const Dr=()=>{if(N.isNativePlatform()){console.log("Service Worker disabled on native platform"),"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(e=>{for(const t of e)t.unregister()});return}const n=Mr({onNeedRefresh(){Pr(n)},onOfflineReady(){console.log("App ready to work offline")},onRegistered(e){console.log("Service Worker registered successfully"),e&&setInterval(()=>{e.update()},3600*1e3)},onRegisterError(e){console.log("Service Worker registration failed:",e)}})},Pr=n=>{const e=document.getElementById("updateNotification");if(!e)return;e.style.display="block",document.getElementById("updateButton")?.addEventListener("click",()=>{n(!0)},{once:!0}),document.getElementById("dismissUpdate")?.addEventListener("click",()=>{e.style.display="none"},{once:!0})};function _r({measurementsState:n,timeState:e,connectionsState:t,streamManager:o}){As(e);const s=cr({connectionsState:t,measurementsState:n});Br(),Dr(),Ir(),Ar(),yr(),vr(o,e),wn(),So();const a=document.getElementById("toggleDarkMode");return a&&Er(a),ls(),Ha({measurementsState:n,timeState:e}),Lr(n,e).then(i=>{i&&(console.log("Workout recovered from previous session"),document.dispatchEvent(new CustomEvent("workout-recovered")))}),Za({measurementsState:n,timeState:e,zoneState:s}),Ka(n,s),ja(),Ja({measurementsState:n,timeState:e,zoneState:s}),s}var Qt;(function(n){n[n.SCAN_MODE_LOW_POWER=0]="SCAN_MODE_LOW_POWER",n[n.SCAN_MODE_BALANCED=1]="SCAN_MODE_BALANCED",n[n.SCAN_MODE_LOW_LATENCY=2]="SCAN_MODE_LOW_LATENCY"})(Qt||(Qt={}));var en;(function(n){n[n.CONNECTION_PRIORITY_BALANCED=0]="CONNECTION_PRIORITY_BALANCED",n[n.CONNECTION_PRIORITY_HIGH=1]="CONNECTION_PRIORITY_HIGH",n[n.CONNECTION_PRIORITY_LOW_POWER=2]="CONNECTION_PRIORITY_LOW_POWER"})(en||(en={}));function Nr(n){return new DataView(Uint8Array.from(n).buffer)}function Rr(n){return Array.from(new Uint8Array(n.buffer,n.byteOffset,n.byteLength))}function Or(n){return`0000${n.toString(16).padStart(4,"0")}-0000-1000-8000-00805f9b34fb`}function In(n){const e=[];let t,o,s=1,a=0;for(t=0;t<n.length;t++)o=n.charCodeAt(t),(o>47&&o<58||o>64&&o<71||o>96&&o<103)&&(a=a<<4^(o>64?o+9:o)&15,(s^=1)&&e.push(a&255));return Nr(e)}function Be(n){return Rr(n).map(e=>{let t=e.toString(16);return t.length==1&&(t="0"+t),t}).join("")}function mi(n){if(typeof n=="string")return n;if(typeof n=="number")return Or(n);throw new Error("Invalid UUID")}function pi(n){const e={};if(n)return n.forEach((t,o)=>{e[o.toString()]=t}),e}function tn(n){if(n!==void 0){if(typeof n=="string"){const e=In(n);return new Uint8Array(e.buffer,e.byteOffset,e.byteLength)}return n instanceof DataView?new Uint8Array(n.buffer,n.byteOffset,n.byteLength):n}}function He(n){if(n!==void 0)return n instanceof DataView?Be(n):Be(new DataView(n.buffer,n.byteOffset,n.byteLength))}const k=Te("BluetoothLe",{web:()=>xt(()=>import("./web-BfTJvUNk.js"),[]).then(n=>new n.BluetoothLeWeb)}),Vr=()=>{let n=Promise.resolve();return e=>new Promise((t,o)=>{n=n.then(()=>e()).then(t).catch(o)})};function ct(n){return n?Vr():e=>e()}function B(n){if(typeof n!="string")throw new Error(`Invalid UUID type ${typeof n}. Expected string.`);if(n=n.toLowerCase(),!(n.search(/^[0-9a-f]{8}\b-[0-9a-f]{4}\b-[0-9a-f]{4}\b-[0-9a-f]{4}\b-[0-9a-f]{12}$/)>=0))throw new Error(`Invalid UUID format ${n}. Expected 128 bit string (e.g. "0000180d-0000-1000-8000-00805f9b34fb").`);return n}class Fr{constructor(){this.scanListener=null,this.eventListeners=new Map,this.queue=ct(!0)}enableQueue(){this.queue=ct(!0)}disableQueue(){this.queue=ct(!1)}async initialize(e){await this.queue(async()=>{await k.initialize(e)})}async isEnabled(){return await this.queue(async()=>(await k.isEnabled()).value)}async requestEnable(){await this.queue(async()=>{await k.requestEnable()})}async enable(){await this.queue(async()=>{await k.enable()})}async disable(){await this.queue(async()=>{await k.disable()})}async startEnabledNotifications(e){await this.queue(async()=>{var t;const o="onEnabledChanged";await((t=this.eventListeners.get(o))===null||t===void 0?void 0:t.remove());const s=await k.addListener(o,a=>{e(a.value)});this.eventListeners.set(o,s),await k.startEnabledNotifications()})}async stopEnabledNotifications(){await this.queue(async()=>{var e;const t="onEnabledChanged";await((e=this.eventListeners.get(t))===null||e===void 0?void 0:e.remove()),this.eventListeners.delete(t),await k.stopEnabledNotifications()})}async isLocationEnabled(){return await this.queue(async()=>(await k.isLocationEnabled()).value)}async openLocationSettings(){await this.queue(async()=>{await k.openLocationSettings()})}async openBluetoothSettings(){await this.queue(async()=>{await k.openBluetoothSettings()})}async openAppSettings(){await this.queue(async()=>{await k.openAppSettings()})}async setDisplayStrings(e){await this.queue(async()=>{await k.setDisplayStrings(e)})}async requestDevice(e){return e=e?this.validateRequestBleDeviceOptions(e):void 0,await this.queue(async()=>await k.requestDevice(e))}async requestLEScan(e,t){e=this.validateRequestBleDeviceOptions(e),await this.queue(async()=>{var o;await((o=this.scanListener)===null||o===void 0?void 0:o.remove()),this.scanListener=await k.addListener("onScanResult",s=>{const a=Object.assign(Object.assign({},s),{manufacturerData:this.convertObject(s.manufacturerData),serviceData:this.convertObject(s.serviceData),rawAdvertisement:s.rawAdvertisement?this.convertValue(s.rawAdvertisement):void 0});t(a)}),await k.requestLEScan(e)})}async stopLEScan(){await this.queue(async()=>{var e;await((e=this.scanListener)===null||e===void 0?void 0:e.remove()),this.scanListener=null,await k.stopLEScan()})}async getDevices(e){if(!Array.isArray(e))throw new Error("deviceIds must be an array");return this.queue(async()=>(await k.getDevices({deviceIds:e})).devices)}async getConnectedDevices(e){if(!Array.isArray(e))throw new Error("services must be an array");return e=e.map(B),this.queue(async()=>(await k.getConnectedDevices({services:e})).devices)}async getBondedDevices(){return this.queue(async()=>(await k.getBondedDevices()).devices)}async connect(e,t,o){await this.queue(async()=>{var s;if(t){const a=`disconnected|${e}`;await((s=this.eventListeners.get(a))===null||s===void 0?void 0:s.remove());const i=await k.addListener(a,()=>{t(e)});this.eventListeners.set(a,i)}await k.connect(Object.assign({deviceId:e},o))})}async createBond(e,t){await this.queue(async()=>{await k.createBond(Object.assign({deviceId:e},t))})}async isBonded(e){return await this.queue(async()=>(await k.isBonded({deviceId:e})).value)}async disconnect(e){await this.queue(async()=>{await k.disconnect({deviceId:e})})}async getServices(e){return await this.queue(async()=>(await k.getServices({deviceId:e})).services)}async discoverServices(e){await this.queue(async()=>{await k.discoverServices({deviceId:e})})}async getMtu(e){return await this.queue(async()=>(await k.getMtu({deviceId:e})).value)}async requestConnectionPriority(e,t){await this.queue(async()=>{await k.requestConnectionPriority({deviceId:e,connectionPriority:t})})}async readRssi(e){return await this.queue(async()=>{const o=await k.readRssi({deviceId:e});return parseFloat(o.value)})}async read(e,t,o,s){return t=B(t),o=B(o),await this.queue(async()=>{const i=await k.read(Object.assign({deviceId:e,service:t,characteristic:o},s));return this.convertValue(i.value)})}async write(e,t,o,s,a){return t=B(t),o=B(o),this.queue(async()=>{if(!s?.buffer)throw new Error("Invalid data.");let i=s;N.getPlatform()!=="web"&&(i=Be(s)),await k.write(Object.assign({deviceId:e,service:t,characteristic:o,value:i},a))})}async writeWithoutResponse(e,t,o,s,a){t=B(t),o=B(o),await this.queue(async()=>{if(!s?.buffer)throw new Error("Invalid data.");let i=s;N.getPlatform()!=="web"&&(i=Be(s)),await k.writeWithoutResponse(Object.assign({deviceId:e,service:t,characteristic:o,value:i},a))})}async readDescriptor(e,t,o,s,a){return t=B(t),o=B(o),s=B(s),await this.queue(async()=>{const r=await k.readDescriptor(Object.assign({deviceId:e,service:t,characteristic:o,descriptor:s},a));return this.convertValue(r.value)})}async writeDescriptor(e,t,o,s,a,i){return t=B(t),o=B(o),s=B(s),this.queue(async()=>{if(!a?.buffer)throw new Error("Invalid data.");let r=a;N.getPlatform()!=="web"&&(r=Be(a)),await k.writeDescriptor(Object.assign({deviceId:e,service:t,characteristic:o,descriptor:s,value:r},i))})}async startNotifications(e,t,o,s,a){t=B(t),o=B(o),await this.queue(async()=>{var i;const r=`notification|${e}|${t}|${o}`;await((i=this.eventListeners.get(r))===null||i===void 0?void 0:i.remove());const c=await k.addListener(r,d=>{s(this.convertValue(d?.value))});this.eventListeners.set(r,c),await k.startNotifications(Object.assign({deviceId:e,service:t,characteristic:o},a))})}async stopNotifications(e,t,o){t=B(t),o=B(o),await this.queue(async()=>{var s;const a=`notification|${e}|${t}|${o}`;await((s=this.eventListeners.get(a))===null||s===void 0?void 0:s.remove()),this.eventListeners.delete(a),await k.stopNotifications({deviceId:e,service:t,characteristic:o})})}validateRequestBleDeviceOptions(e){return e.services&&(e.services=e.services.map(B)),e.optionalServices&&(e.optionalServices=e.optionalServices.map(B)),e.serviceData&&N.getPlatform()!=="web"&&(e.serviceData=e.serviceData.map(t=>Object.assign(Object.assign({},t),{serviceUuid:B(t.serviceUuid),dataPrefix:He(t.dataPrefix),mask:He(t.mask)}))),e.manufacturerData&&(N.getPlatform()!=="web"?e.manufacturerData=e.manufacturerData.map(t=>Object.assign(Object.assign({},t),{dataPrefix:He(t.dataPrefix),mask:He(t.mask)})):e.manufacturerData=e.manufacturerData.map(t=>Object.assign(Object.assign({},t),{dataPrefix:tn(t.dataPrefix),mask:tn(t.mask)}))),e}convertValue(e){return typeof e=="string"?In(e):e===void 0?new DataView(new ArrayBuffer(0)):e}convertObject(e){if(e===void 0)return;const t={};for(const o of Object.keys(e))t[o]=this.convertValue(e[o]);return t}}const A=new Fr,$n=n=>{const e=n.getUint16(0,!0);let t=2;const o={},s=(e&2)!==0,a=(e&4)!==0,i=(e&8)!==0;if(n.byteLength>=t+2){const r=n.getUint16(t,!0);o.speed=r/100,t+=2}if(s&&n.byteLength>=t+2){const r=n.getUint16(t,!0);o.averageSpeed=r/100,t+=2}if(a&&n.byteLength>=t+3){const r=n.getUint8(t),c=n.getUint8(t+1),d=n.getUint8(t+2),p=r+(c<<8)+(d<<16);o.totalDistance=p,t+=3}if(i&&n.byteLength>=t+4){const r=n.getInt16(t,!0);o.incline=r/10,t+=2;const c=n.getInt16(t,!0);o.rampAngle=c/10,t+=2}return o},lt="00001818-0000-1000-8000-00805f9b34fb",nn="00002a63-0000-1000-8000-00805f9b34fb",Ue="0000180d-0000-1000-8000-00805f9b34fb",on="00002a37-0000-1000-8000-00805f9b34fb",ze="00001816-0000-1000-8000-00805f9b34fb",sn="00002a5b-0000-1000-8000-00805f9b34fb",We="00001826-0000-1000-8000-00805f9b34fb",an="00002acd-0000-1000-8000-00805f9b34fb",W=5,Qe=1e3;let rn=!1;const et=async()=>{if(!rn)try{await A.initialize(),rn=!0}catch(n){throw console.error("Failed to initialize BleClient:",n),n}},Hr=async()=>{const n=[],e=[];let t=null,o=!1,s=0;await et();let a;try{a=await A.requestDevice({services:[lt],optionalServices:[]})}catch(l){throw console.error("Error requesting Power device:",l),l}t=a.deviceId;const i=a.name||"Power Sensor",r=l=>{e.forEach(m=>m(l))},c=async()=>{t&&(await A.connect(t,p),r("connected"),await A.startNotifications(t,lt,nn,l=>{Z.log(i,l);const m=l.getInt16(2,!0),u={timestamp:Date.now(),value:m};n.forEach(h=>h(u))}),s=0)},d=async()=>{if(o||s>=W){s>=W&&(console.error("Native Power sensor: Max reconnection attempts reached"),r("failed"));return}s++;const l=Qe*Math.pow(2,s-1);console.log(`Native Power sensor: Reconnection attempt ${s}/${W} in ${l}ms`),r("reconnecting"),await new Promise(m=>setTimeout(m,l));try{await c(),console.log("Native Power sensor: Reconnected successfully")}catch(m){console.error("Native Power sensor: Reconnection failed:",m),d()}},p=l=>{l===t&&!o&&(console.log("Native Power sensor: Disconnected"),r("disconnected"),d())};return await c(),{disconnect:async()=>{if(o=!0,t)try{await A.stopNotifications(t,lt,nn),await A.disconnect(t)}catch(l){console.error("Error disconnecting native bluetooth:",l)}},addListener:l=>{n.push(l)},deviceName:i,onStatusChange:l=>{e.push(l)}}},Ur=async()=>{const n=[],e=[];let t=null,o=!1,s=0;await et();let a;try{a=await A.requestDevice({services:[Ue],optionalServices:[Ue]})}catch(l){throw console.error("Error requesting Heart Rate device:",l),l}t=a.deviceId;const i=a.name||"Heart Rate Monitor",r=l=>{e.forEach(m=>m(l))},c=async()=>{t&&(await A.connect(t,p),r("connected"),await A.startNotifications(t,Ue,on,l=>{Z.log(i,l);const m=l.getUint8(0);let u;m&1?u=l.getUint16(1,!0):u=l.getUint8(1);const h={timestamp:Date.now(),value:u};n.forEach(g=>g(h))}),s=0)},d=async()=>{if(o||s>=W){s>=W&&(console.error("Native Heart Rate sensor: Max reconnection attempts reached"),r("failed"));return}s++;const l=Qe*Math.pow(2,s-1);console.log(`Native Heart Rate sensor: Reconnection attempt ${s}/${W} in ${l}ms`),r("reconnecting"),await new Promise(m=>setTimeout(m,l));try{await c(),console.log("Native Heart Rate sensor: Reconnected successfully")}catch(m){console.error("Native Heart Rate sensor: Reconnection failed:",m),d()}},p=l=>{l===t&&!o&&(console.log("Native Heart Rate sensor: Disconnected"),r("disconnected"),d())};return await c(),{disconnect:async()=>{if(o=!0,t)try{await A.stopNotifications(t,Ue,on),await A.disconnect(t)}catch(l){console.error("Error disconnecting native bluetooth:",l)}},addListener:l=>{n.push(l)},deviceName:i,onStatusChange:l=>{e.push(l)}}},zr=async()=>{const n=[],e=[];let t=null,o=null,s=null,a=!1,i=0;await et();let r;try{r=await A.requestDevice({services:[ze],optionalServices:[ze]})}catch(u){throw console.error("Error requesting Cadence device:",u),u}t=r.deviceId;const c=r.name||"Cadence Sensor",d=u=>{e.forEach(h=>h(u))},p=async()=>{t&&(await A.connect(t,m),d("connected"),await A.startNotifications(t,ze,sn,u=>{Z.log(c,u);const h=u.getUint8(0);if(h&2){let g=1;h&1&&(g=7);const y=u.getUint16(g,!0),b=u.getUint16(g+2,!0);if(o!==null&&s!==null){let v=y-o,w=b-s;if(v<0&&(v+=65536),w<0&&(w+=65536),w>0){const f=w/1024,T=Math.round(v/f*60);if(T>=0&&T<300){const I={timestamp:Date.now(),value:T};n.forEach(E=>E(I))}}}o=y,s=b}}),i=0)},l=async()=>{if(a||i>=W){i>=W&&(console.error("Native Cadence sensor: Max reconnection attempts reached"),d("failed"));return}i++;const u=Qe*Math.pow(2,i-1);console.log(`Native Cadence sensor: Reconnection attempt ${i}/${W} in ${u}ms`),d("reconnecting"),await new Promise(h=>setTimeout(h,u));try{await p(),console.log("Native Cadence sensor: Reconnected successfully")}catch(h){console.error("Native Cadence sensor: Reconnection failed:",h),l()}},m=u=>{u===t&&!a&&(console.log("Native Cadence sensor: Disconnected"),d("disconnected"),l())};return await p(),{disconnect:async()=>{if(a=!0,t)try{await A.stopNotifications(t,ze,sn),await A.disconnect(t)}catch(u){console.error("Error disconnecting native bluetooth:",u)}},addListener:u=>{n.push(u)},deviceName:c,onStatusChange:u=>{e.push(u)}}},Wr=async()=>{const n=[],e=[];let t=null,o=!1,s=0;await et();let a;try{a=await A.requestDevice({services:[We],optionalServices:[We]})}catch(l){throw console.error("Error requesting Treadmill device:",l),l}t=a.deviceId;const i=a.name||"Treadmill",r=l=>{e.forEach(m=>m(l))},c=l=>{l===t&&!o&&(console.log("Treadmill: Connection lost, attempting to reconnect..."),r("disconnected"),p())},d=async()=>{t&&(await A.connect(t,c),r("connected"),await A.startNotifications(t,We,an,l=>{Z.log(i,l);try{const m=$n(l);if(m.speed!==void 0||m.incline!==void 0){const u={timestamp:Date.now(),speed:m.speed??null,incline:m.incline??null};n.forEach(h=>h(u))}}catch(m){console.error("Error parsing treadmill data",m)}}),s=0)},p=async()=>{if(o)return;if(s>=W){console.error("Treadmill: Max reconnection attempts reached"),r("failed");return}s++;const l=Qe*Math.pow(2,s-1);console.log(`Treadmill: Reconnection attempt ${s}/${W} in ${l}ms`),r("reconnecting"),await new Promise(m=>setTimeout(m,l));try{await d(),console.log("Treadmill: Reconnected successfully")}catch(m){console.error("Treadmill: Reconnection failed:",m),p()}};try{await d()}catch(l){if(t)try{await A.disconnect(t)}catch{}throw l}return{disconnect:async()=>{if(o=!0,t)try{await A.stopNotifications(t,We,an),await A.disconnect(t)}catch(l){console.error("Error disconnecting treadmill",l)}r("disconnected")},addListener:l=>{n.push(l)},deviceName:i,onStatusChange:l=>{e.push(l)}}},U=5,tt=1e3,qr=async()=>{const n=[],e=[];let t=!1,o=0,s=null;const a=await navigator.bluetooth.requestDevice({filters:[{services:["cycling_power"]}],optionalServices:["cycling_power"]});if(!a.gatt)throw new Error("GATT server not available");const i=a.name||"Power Sensor",r=l=>{e.forEach(m=>m(l))},c=l=>{const u=l.target.value;if(!u)return;Z.log(i,u);const h=u.getInt16(2,!0),g={timestamp:Date.now(),value:h};n.forEach(y=>y(g))},d=async()=>{if(!a.gatt)return;s=await(await(await a.gatt.connect()).getPrimaryService("cycling_power")).getCharacteristic("cycling_power_measurement"),await s.startNotifications(),s.addEventListener("characteristicvaluechanged",c),o=0,r("connected")},p=async()=>{if(t||o>=U){o>=U&&(console.error("Power sensor: Max reconnection attempts reached"),r("failed"));return}o++;const l=tt*Math.pow(2,o-1);console.log(`Power sensor: Reconnection attempt ${o}/${U} in ${l}ms`),r("reconnecting"),await new Promise(m=>setTimeout(m,l));try{await d(),console.log("Power sensor: Reconnected successfully")}catch(m){console.error("Power sensor: Reconnection failed:",m),p()}};return a.addEventListener("gattserverdisconnected",()=>{t||(console.log("Power sensor: Connection lost, attempting to reconnect..."),r("disconnected"),p())}),await d(),{disconnect:()=>{t=!0,s&&(s.removeEventListener("characteristicvaluechanged",c),s.stopNotifications().catch(()=>{})),a.gatt?.disconnect()},addListener:l=>{n.push(l)},deviceName:i,onStatusChange:l=>{e.push(l)}}},jr=async()=>{const n=[],e=[];let t=!1,o=0,s=null;const a=await navigator.bluetooth.requestDevice({filters:[{services:["heart_rate"]}],optionalServices:["heart_rate"]});if(!a.gatt)throw new Error("GATT server not available");const i=a.name||"Heart Rate Monitor",r=l=>{e.forEach(m=>m(l))},c=l=>{const u=l.target.value;if(!u)return;Z.log(i,u);const h=u.getUint8(0);let g;h&1?g=u.getUint16(1,!0):g=u.getUint8(1);const y={timestamp:Date.now(),value:g};n.forEach(b=>b(y))},d=async()=>{if(!a.gatt)return;s=await(await(await a.gatt.connect()).getPrimaryService("heart_rate")).getCharacteristic("heart_rate_measurement"),await s.startNotifications(),s.addEventListener("characteristicvaluechanged",c),o=0,r("connected")},p=async()=>{if(t||o>=U){o>=U&&(console.error("Heart rate sensor: Max reconnection attempts reached"),r("failed"));return}o++;const l=tt*Math.pow(2,o-1);console.log(`Heart rate sensor: Reconnection attempt ${o}/${U} in ${l}ms`),r("reconnecting"),await new Promise(m=>setTimeout(m,l));try{await d(),console.log("Heart rate sensor: Reconnected successfully")}catch(m){console.error("Heart rate sensor: Reconnection failed:",m),p()}};return a.addEventListener("gattserverdisconnected",()=>{t||(console.log("Heart rate sensor: Connection lost, attempting to reconnect..."),r("disconnected"),p())}),await d(),{disconnect:()=>{t=!0,s&&(s.removeEventListener("characteristicvaluechanged",c),s.stopNotifications().catch(()=>{})),a.gatt?.disconnect()},addListener:l=>{n.push(l)},deviceName:i,onStatusChange:l=>{e.push(l)}}},Zr=async()=>{const n=[],e=[];let t=!1,o=0,s=null,a=null,i=null;const r=await navigator.bluetooth.requestDevice({filters:[{services:["cycling_speed_and_cadence"]}],optionalServices:["cycling_speed_and_cadence"]});if(!r.gatt)throw new Error("GATT server not available");const c=r.name||"Cadence Sensor",d=u=>{e.forEach(h=>h(u))},p=u=>{const g=u.target.value;if(!g)return;Z.log(c,g);const y=g.getUint8(0);if(y&2){let b=1;y&1&&(b=7);const v=g.getUint16(b,!0),w=g.getUint16(b+2,!0);if(a!==null&&i!==null){let f=v-a,T=w-i;if(f<0&&(f+=65536),T<0&&(T+=65536),T>0){const I=T/1024,E=Math.round(f/I*60);if(E>=0&&E<300){const C={timestamp:Date.now(),value:E};n.forEach(L=>L(C))}}}a=v,i=w}},l=async()=>{if(!r.gatt)return;s=await(await(await r.gatt.connect()).getPrimaryService("cycling_speed_and_cadence")).getCharacteristic("csc_measurement"),await s.startNotifications(),s.addEventListener("characteristicvaluechanged",p),o=0,d("connected")},m=async()=>{if(t||o>=U){o>=U&&(console.error("Cadence sensor: Max reconnection attempts reached"),d("failed"));return}o++;const u=tt*Math.pow(2,o-1);console.log(`Cadence sensor: Reconnection attempt ${o}/${U} in ${u}ms`),d("reconnecting"),await new Promise(h=>setTimeout(h,u));try{await l(),console.log("Cadence sensor: Reconnected successfully")}catch(h){console.error("Cadence sensor: Reconnection failed:",h),m()}};return r.addEventListener("gattserverdisconnected",()=>{t||(console.log("Cadence sensor: Connection lost, attempting to reconnect..."),d("disconnected"),m())}),await l(),{disconnect:()=>{t=!0,s&&(s.removeEventListener("characteristicvaluechanged",p),s.stopNotifications().catch(()=>{})),r.gatt?.disconnect()},addListener:u=>{n.push(u)},deviceName:c,onStatusChange:u=>{e.push(u)}}},Yr=async()=>{const n=[],e=[];let t=!1,o=0,s=null,a;const i=await navigator.bluetooth.requestDevice({filters:[{services:["fitness_machine"]}],optionalServices:["fitness_machine"]});if(!i.gatt)throw new Error("GATT server not available");const r=i.name||"Treadmill",c=m=>{e.forEach(u=>u(m))},d=m=>{const h=m.target.value;if(h){Z.log(r,h);try{const g=$n(h);if(g.speed!==void 0||g.incline!==void 0){const y={timestamp:Date.now(),speed:g.speed??null,incline:g.incline??null};n.forEach(b=>b(y))}}catch(g){console.error("Error parsing treadmill data",g)}}},p=async()=>{if(!i.gatt)return;a=await i.gatt.connect(),s=await(await a.getPrimaryService("fitness_machine")).getCharacteristic("treadmill_data"),await s.startNotifications(),s.addEventListener("characteristicvaluechanged",d),o=0,c("connected")},l=async()=>{if(t||o>=U){o>=U&&(console.error("Treadmill: Max reconnection attempts reached"),c("failed"));return}o++;const m=tt*Math.pow(2,o-1);console.log(`Treadmill: Reconnection attempt ${o}/${U} in ${m}ms`),c("reconnecting"),await new Promise(u=>setTimeout(u,m));try{await p(),console.log("Treadmill: Reconnected successfully")}catch(u){console.error("Treadmill: Reconnection failed:",u),l()}};i.addEventListener("gattserverdisconnected",()=>{t||(console.log("Treadmill: Connection lost, attempting to reconnect..."),c("disconnected"),l())});try{await p()}catch(m){throw a&&a.connected&&a.disconnect(),m}return{disconnect:()=>{if(t=!0,s)try{s.stopNotifications(),s.removeEventListener("characteristicvaluechanged",d)}catch{}i.gatt?.connected&&i.gatt.disconnect(),c("disconnected")},addListener:m=>{n.push(m)},deviceName:r,onStatusChange:m=>{e.push(m)}}},nt={connectPower:async()=>N.isNativePlatform()?Hr():qr(),connectHeartRate:async()=>N.isNativePlatform()?Ur():jr(),connectCadence:async()=>N.isNativePlatform()?zr():Zr(),connectTreadmill:async()=>N.isNativePlatform()?Wr():Yr()},Gr=async()=>nt.connectCadence(),Kr=async()=>nt.connectHeartRate(),Jr=async()=>nt.connectPower(),Xr=async()=>nt.connectTreadmill(),dt=Te("BackgroundGeolocation"),Qr=()=>{let n=null;return{start:async e=>{try{n=await dt.addWatcher({backgroundMessage:"Tracking your ride.",backgroundTitle:"Bike Power Tracker",requestPermissions:!0,stale:!1,distanceFilter:10},(t,o)=>{if(o)return o.code==="NOT_AUTHORIZED"&&window.confirm(`This app needs your location, but does not have permission.

Open settings now?`)&&dt.openSettings(),console.error(o);if(t){const s={timestamp:t.time||Date.now(),lat:t.latitude,lon:t.longitude,accuracy:t.accuracy,altitude:t.altitude,speed:t.speed,heading:t.bearing};e(s)}})}catch(t){console.error("Error starting native GPS:",t)}},stop:async()=>{n&&(await dt.removeWatcher({id:n}),n=null)}}},ei=()=>{let n=null;return{start:async e=>{if(!("geolocation"in navigator)){console.warn("Geolocation is not supported by this browser.");return}n=navigator.geolocation.watchPosition(t=>{const o={timestamp:t.timestamp,lat:t.coords.latitude,lon:t.coords.longitude,accuracy:t.coords.accuracy,altitude:t.coords.altitude,speed:t.coords.speed,heading:t.coords.heading};e(o)},t=>{console.error("Error watching position:",t)},{enableHighAccuracy:!0,timeout:5e3,maximumAge:0})},stop:async()=>{n!==null&&(navigator.geolocation.clearWatch(n),n=null)}}},ti={create:()=>N.isNativePlatform()?Qr():ei()},ni=async n=>{const e=ti.create();return await e.start(n),{stop:async()=>e.stop(),deviceName:"GPS Sensor"}},An={power:"Power Meter",heartrate:"Heart Rate Monitor",cadence:"Cadence Sensor",speed:"Speed Sensor",distance:"Distance Sensor",altitude:"Altimeter",gps:"GPS",treadmill:"Treadmill",treadmillSpeed:"Treadmill Speed"},Bn={power:"⚡",heartrate:"❤️",cadence:"🚴",speed:"💨",distance:"📏",altitude:"🏔️",gps:"📍",treadmill:"🏃",treadmillSpeed:"🏃"};function oi(n,e){const t=An[e],o=n instanceof Error?n.message:String(n),s=n instanceof Error?n.name:"";return o.includes("User cancelled")||o.includes("cancelled the requestDevice")?{title:"Connection Cancelled",message:`${t} pairing was cancelled.`,suggestions:["Click the connect button to try again","Make sure your sensor is powered on and in range"],canRetry:!0}:o.includes("Bluetooth adapter not available")||o.includes("Web Bluetooth API is not available")||s==="NotFoundError"&&o.includes("Bluetooth")?{title:"Bluetooth Unavailable",message:"Bluetooth is not available on this device or browser.",suggestions:["Check that Bluetooth is enabled in your device settings","Try using Chrome, Edge, or another browser that supports Web Bluetooth","On macOS, ensure Bluetooth permissions are granted in System Preferences","On Windows, check that your Bluetooth adapter is working"],canRetry:!1}:o.includes("No Bluetooth devices")||o.includes("No devices found")||s==="NotFoundError"&&!o.includes("Bluetooth")?{title:"No Sensors Found",message:`No compatible ${t.toLowerCase()} was found nearby.`,suggestions:["Make sure your sensor is powered on","Wake up the sensor by spinning the pedals or moving","Bring the sensor closer to your device","Check that the sensor battery is not depleted","Ensure the sensor is not connected to another device"],canRetry:!0}:o.includes("GATT")||o.includes("Connection failed")||o.includes("connect")&&o.includes("fail")?{title:"Connection Failed",message:`Could not connect to the ${t.toLowerCase()}.`,suggestions:["Try moving closer to the sensor","Power cycle the sensor (turn off and on again)","Check that no other device is connected to this sensor","Restart Bluetooth on your device","If using a phone, try closing other Bluetooth apps"],canRetry:!0}:o.includes("SecurityError")||o.includes("permission")||s==="SecurityError"?{title:"Permission Denied",message:"Bluetooth permission was denied.",suggestions:["Check your browser settings to allow Bluetooth access",'If prompted, click "Allow" to grant Bluetooth permission',"Try refreshing the page and connecting again","On some browsers, you may need to access this site over HTTPS"],canRetry:!0}:o.includes("NetworkError")||o.includes("timeout")||s==="NetworkError"?{title:"Connection Timed Out",message:`The connection to your ${t.toLowerCase()} timed out.`,suggestions:["Make sure the sensor is in range and powered on","Try moving closer to the sensor","Power cycle the sensor and try again","Check for interference from other wireless devices"],canRetry:!0}:o.includes("Service")&&o.includes("not found")?{title:"Incompatible Sensor",message:`This device doesn't appear to be a compatible ${t.toLowerCase()}.`,suggestions:["Make sure you selected the correct sensor type","Check that your sensor supports standard Bluetooth protocols","Some sensors may require a firmware update","Consult your sensor's documentation for compatibility"],canRetry:!0}:{title:"Connection Error",message:`Failed to connect to ${t.toLowerCase()}.`,suggestions:["Make sure the sensor is powered on and nearby","Try power cycling the sensor","Restart Bluetooth on your device","Refresh the page and try again"],canRetry:!0}}function si(n){const e=document.createElement("div");e.className="connection-error-content";const t=document.createElement("p");if(t.className="connection-error-message",t.textContent=n.message,e.appendChild(t),n.suggestions.length>0){const o=document.createElement("div");o.className="connection-error-troubleshooting";const s=document.createElement("h3");s.textContent="💡 Troubleshooting Tips",o.appendChild(s);const a=document.createElement("ul");a.setAttribute("role","list"),n.suggestions.forEach(i=>{const r=document.createElement("li");r.textContent=i,a.appendChild(r)}),o.appendChild(a),e.appendChild(o)}return e}function ai(n,e,t){return new Promise(o=>{const s=oi(n,e),a=Bn[e],i=si(s);console.error(`[${e}] Connection error:`,n),S(`${s.title}. ${s.message}`,"assertive");let r=null;const c=[];c.push({text:"Dismiss",variant:"secondary",onClick:()=>{r?.(),o(!1)}}),s.canRetry&&c.push({text:"Try Again",variant:"primary",onClick:()=>{r?.(),t&&t(),o(!0)}}),r=Ke({title:s.title,icon:a,content:i,buttons:c,closeOnOverlay:!0,onClose:()=>o(!1)})})}function ri(n,e){const t=An[n],o=Bn[n],s=document.createElement("div");s.className="connection-error-content";const a=document.createElement("p");a.className="connection-error-message",a.textContent=`Lost connection to your ${t.toLowerCase()} and automatic reconnection failed.`,s.appendChild(a);const i=document.createElement("div");i.className="connection-error-troubleshooting";const r=document.createElement("h3");r.textContent="💡 To reconnect:",i.appendChild(r);const c=document.createElement("ul");c.setAttribute("role","list"),["Make sure the sensor is still powered on","Move closer to the sensor",'Click "Try Again" to reconnect manually'].forEach(p=>{const l=document.createElement("li");l.textContent=p,c.appendChild(l)}),i.appendChild(c),s.appendChild(i),S(`${t} connection lost. Automatic reconnection failed.`,"assertive");let d=null;d=Ke({title:"Connection Lost",icon:o,content:s,buttons:[{text:"Dismiss",variant:"secondary",onClick:()=>{d?.()}},{text:"Try Again",variant:"primary",onClick:()=>{d?.(),e?.()}}],closeOnOverlay:!0})}const ii={power:"⚡",heartrate:"❤️",cadence:"🚴",speed:"💨",distance:"📏",altitude:"🏔️",gps:"📍",treadmill:"🏃",treadmillSpeed:"🏃"},qe=n=>n.charAt(0).toUpperCase()+n.slice(1),ci=({connectionsState:n,measurementsState:e})=>{const t=(c,d,p)=>{const l=Ze[c]?.connect;if(!l)return;const m=qe(c),u=ii[c];switch(d){case"connected":p?l.textContent=`${u} Disconnect ${m} (${p})`:l.textContent=`${u} Disconnect ${m}`;break;case"reconnecting":l.textContent=`${u} Reconnecting ${m}...`;break;case"disconnected":l.textContent=`${u} Connect ${m}`;break}},o=c=>{const d=n[c];if(d&&typeof d.disconnect=="function"){d.disconnect(),d.disconnect=null,d.isConnected=!1,t(c,"disconnected");const p=Ze[c]?.display;p&&(p.textContent="--")}},s=(c,d)=>p=>{const l=qe(c);switch(p){case"connected":t(c,"connected",d),F(`${l} sensor reconnected`,"success");break;case"reconnecting":t(c,"reconnecting");break;case"failed":n[c]&&(n[c].isConnected=!1,n[c].disconnect=null),t(c,"disconnected"),ri(c,()=>a(c));break}},a=async c=>{try{t(c,"reconnecting");let d;if(c==="gps"){const h=await ni(y=>{e.addGps(y)}),g=n[c];g&&(g.disconnect=async()=>{await h.stop()},g.isConnected=!0),t(c,"connected",h.deviceName),F(`Connected to ${qe(c)}`,"success");return}else if(c==="treadmill")d=await Xr(),d.addListener(h=>{e.addTreadmillData(h)});else if(c==="power")d=await Jr(),d.addListener(h=>{e.addPower(h)});else if(c==="heartrate")d=await Kr(),d.addListener(h=>{e.addHeartrate(h)});else if(c==="cadence")d=await Gr(),d.addListener(h=>{e.addCadence(h)});else return;const{disconnect:p,deviceName:l,onStatusChange:m}=d,u=n[c];u&&(u.disconnect=p,u.isConnected=!0),t(c,"connected",l),F(`Connected to ${qe(c)}`,"success"),m&&m(s(c,l||"Sensor"))}catch(d){t(c,"disconnected"),await ai(d,c,()=>a(c))||n[c]&&(n[c].isConnected=!1)}},i=c=>{const d=Ze[c]?.connect;if(!d)return;const p=l=>{l.stopPropagation(),n[c]?.isConnected?o(c):a(c)};d.addEventListener("click",p)};["power","heartrate","cadence","gps","treadmill"].forEach(i)};class li{isStreaming=!1;isPaused=!1;streamName=null;streamInterval=null;measurementsState;timeState;constructor(e,t){this.measurementsState=e,this.timeState=t}async startStreaming(e){if(this.isStreaming)return this.streamName;try{const t=e||`workout-${Date.now()}`,o=await dr(t);if(!o.success)throw new Error("Failed to create stream");return this.streamName=o.streamName,this.isStreaming=!0,this.isPaused=!1,this._startStreamingLoop(),this.streamName}catch(t){throw console.error("Failed to start streaming:",t),this.streamName=null,t}}pauseStreaming(){this.isStreaming&&(this.isPaused=!0)}resumeStreaming(){this.isStreaming&&(this.isPaused=!1)}async stopStreaming(){this.isStreaming&&(this.isStreaming=!1,this.isPaused=!1,this.streamInterval&&(clearInterval(this.streamInterval),this.streamInterval=null),this.streamName=null)}getStatus(){return{isStreaming:this.isStreaming,isPaused:this.isPaused,streamName:this.streamName}}_startStreamingLoop(){this.streamInterval=setInterval(async()=>{if(!(!this.isStreaming||this.isPaused||!this.timeState.running))try{await this._sendCurrentData()}catch(e){console.error("Error sending workout data:",e)}},1e3)}async _sendCurrentData(){if(!this.streamName)return;const e=this._getLatestValue("power"),t=this._getLatestValue("cadence"),o=this._getLatestValue("heartrate"),s=this._getLatestValue("speed"),a=this._getLatestValue("distance"),i=this._getLatestValue("altitude"),r=this._getLatestTreadmillIncline();if(e===null&&t===null&&o===null&&s===null&&a===null&&i===null&&r===null)return;const c=this.timeState.running&&this.timeState.startTime?Date.now()-this.timeState.startTime:this.timeState.endTime&&this.timeState.startTime?this.timeState.endTime-this.timeState.startTime:0;await gr(this.streamName,{timestamp:Date.now(),elapsed:Math.floor(c/1e3).toString(),power:e,cadence:t,heartrate:o,speed:s,distance:a,altitude:i,incline:r})}_getLatestValue(e){const t=this.measurementsState[e];if(!Array.isArray(t)||t.length===0)return null;const o=t[t.length-1];return Date.now()-o.timestamp>5e3?null:o.value}_getLatestTreadmillIncline(){const e=this.measurementsState.treadmill;if(!Array.isArray(e)||e.length===0)return null;const t=e[e.length-1];return Date.now()-t.timestamp>5e3?null:t.incline}}function di({measurementsState:n,connectionsState:e,timeState:t}){return ci({connectionsState:e,measurementsState:n}),{streamManager:new li(n,t)}}const cn=()=>{try{const{measurementsState:n,connectionsState:e,timeState:t}=Xn();Qn({measurementsState:n,connectionsState:e});const{streamManager:o}=di({measurementsState:n,connectionsState:e,timeState:t});_r({measurementsState:n,timeState:t,connectionsState:e,streamManager:o});const s=$s();s.start(),window.router=s}catch(n){console.error("Failed to initialize app:",n)}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",cn,{once:!0}):cn();console.log("Bike Power Tracker initialized");export{Et as W,In as h,pi as m,mi as w};
//# sourceMappingURL=index-1uSJpr8G.js.map
