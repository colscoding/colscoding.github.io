import{g as n}from"./index-DiG7OM9t.js";import{r as l,u as c,a as h,b as g}from"./screens-D6jiR1Sk.js";import"./FieldPickerComponent-Dn-AMgZU.js";import"./feature-bluetooth-DIdcc21I.js";import"./vendor-core-Dob3nYDb.js";import"./feature-export-7zlEGvkQ.js";import"./vendor-leaflet-3-yx3GaH.js";class i extends HTMLElement{shadow;screen=null;draggedSlotId=null;fieldPicker=null;editingSlotId=null;static LAYOUTS=[{value:"auto",label:"Auto"},{value:"grid-2",label:"2 Columns"},{value:"grid-3",label:"3 Columns"},{value:"grid-4",label:"4 Columns"},{value:"list",label:"List"}];constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this.removeEventListeners()}setScreen(e){this.screen={...e,slots:[...e.slots]},this.render()}getScreen(){return this.screen}reset(e){this.screen={...e,slots:[...e.slots]},this.render()}render(){if(!this.screen){this.shadow.innerHTML=`
...
//# sourceMappingURL=ScreenEditorComponent-BXmTVkKS.js.map
